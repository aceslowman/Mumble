...
Route::group(['middleware' => 'auth'], function () {
	...
	Route::post('/photos/create'              ,'PhotoController@create'       )->name('create_photo');
	Route::post('/carousel/add'               ,'PhotoController@addtoCarousel'  )->name('addto_carousel');
	Route::post('/carousel/remove'               ,'PhotoController@removefromCarousel'  )->name('removefrom_carousel');
});
